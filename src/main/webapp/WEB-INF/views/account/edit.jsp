...
<meta charset="UTF-8">
    ...
    <title>LHPWEB - Edit profile</title>
                    ...
                    <div class="login">
                        ...
                        <div class="login-form">
                            <div class="login-detail">
                                <form:form action="/acc/edit" modelAttribute="form" enctype="multipart/form-data">
                                	<div class="mb-3">
                                    ...
                                    <form:input path="username" type="text" class="form-control" id="formGroupExampleInput" readonly="true" />
                                  </div>
                                  <div class="mb-3">
                                  ...
                                  <button type="submit" class="btn btn-danger" style="width: 100%; margin-top: 5px;">Cập nhật</button>
                                </form:form>
                            </div>
	                            <div class="login-regis">
	                                <a  href="acc/changepass" type="button" class="btn btn btn-primary">Đổi mật khẩu</a>
	                            </div>
                        </div>
                    </div>
                </div>
